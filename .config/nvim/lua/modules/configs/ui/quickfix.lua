-- source: https://github.com/santhosh-tekuri/dotfiles/blob/master/.config/nvim/lua/quickfix.lua
...
function M.quickfix_text(info)
  ...
  for _, item in ipairs(list.items) do
    ...
    if item.bufnr == 0 then
      ...
      local hl = typeHighlights[item.type] or 'qfText'
