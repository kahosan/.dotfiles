...
local plug_map = {
	...
	["n|<leader>Sj"] = map_cr("BufferLineMoveNext"):with_noremap():with_silent(),
	["n|<leader>Sk"] = map_cr("BufferLineMovePrev"):with_noremap():with_silent(),
	...
	["t|<leader>S-d"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").exit()]]):with_noremap():with_silent(),
	...
	-- Plugin Tabout
	-- ["i|<Tab>"] = map_cmd([[<Plug>(TaboutMulti)]]):with_silent(),
	-- ["i|<S-Tab>"] = map_cmd([[<Plug>(TaboutBackMulti)]]):with_silent(),
	-- Plugin Diffview
