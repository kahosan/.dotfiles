...
highlight({
  ...
  BlinkCmpKindClass = { fg = c.color3 },
  BlinkCmpKindColor = { fg = c.color6 },
  BlinkCmpKindConstant = { fg = c.color8 },
  BlinkCmpKindConstructor = { fg = c.color1 },
  BlinkCmpKindEnum = { fg = c.color12 },
  BlinkCmpKindEnumMember = { fg = c.color6 },
  BlinkCmpKindEvent = { fg = c.color1 },
  BlinkCmpKindField = { fg = c.color12 },
  BlinkCmpKindFile = { fg = c.color1 },
  BlinkCmpKindFolder = { fg = c.color1 },
  BlinkCmpKindFunction = { fg = c.color1 },
  BlinkCmpKindInterface = { fg = c.color3 },
  BlinkCmpKindKeyword = { fg = c.color6 },
  BlinkCmpKindMethod = { fg = c.color1 },
  BlinkCmpKindModule = { fg = c.color1 },
  BlinkCmpKindOperator = { fg = c.color1 },
  BlinkCmpKindProperty = { fg = c.color12 },
  BlinkCmpKindReference = { fg = c.color6 },
  BlinkCmpKindSnippet = { fg = c.color7 },
  BlinkCmpKindStruct = { fg = c.color1 },
  BlinkCmpKindText = { fg = c.color11 },
  BlinkCmpKindTypeParameter = { fg = c.color1 },
